...
CREATE TABLE IF NOT EXISTS  t_user_relationship  (
		 ...
		 f_user1_teamname VARCHAR(32) NOT NULL DEFAULT 'my good friend' COMMENT "用户2在用户1的好友分组名称",
		 f_user1_markname VARCHAR(32) COMMENT "用户2在用户1的备注名称",		 
		 f_user2_teamname VARCHAR(32) NOT NULL DEFAULT "my good friend" COMMENT "用户1在用户2的好友分组名称",
